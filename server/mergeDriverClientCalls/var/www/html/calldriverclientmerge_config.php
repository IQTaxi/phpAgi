...
class CallMerger
{
    ...
    {
        $default_config = "; Call Merge Configuration File
...
";
     ...
     */
    public function mergeCallsSimple($phone1, $phone2, $conference_room = null, $wait_time = null)
    {
        try {
     ...
     */
    public function mergeCallsWithCallFile($phone1, $phone2, $conference_room = null, $wait_time = null)
    {
        try {
            // Use config default if wait_time not provided
            if ($wait_time === null) {
...
if (isset($_GET['phone1']) && isset($_GET['phone2'])) {
    ...
    // Display usage
    echo "Call Merge Script - Configuration-based Call Merging\n";
    echo "=================================================\n";
...
if (!isset($_GET['phone1']) && !isset($_POST['phone1']) && !isset($argv[1])) {
    ...
    <body>
        <h1>Call Merge Test - Configuration Based</h1>
